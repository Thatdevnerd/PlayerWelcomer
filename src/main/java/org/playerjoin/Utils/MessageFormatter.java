...
public class MessageFormatter {
     ...
     */
    public static com.hypixel.hytale.server.core.Message format(String text) {
        if (text == null || text.isEmpty()) {
            return com.hypixel.hytale.server.core.Message.raw("");
        }
        ...
        List<com.hypixel.hytale.server.core.Message> allMessages = new ArrayList<>();
        for (int i = 0; i < lines.length; i++) {
            if (i > 0)
                allMessages.add(com.hypixel.hytale.server.core.Message.raw("\n"));
            allMessages.add(processLine(lines[i]));
        }

        return com.hypixel.hytale.server.core.Message.join(allMessages.toArray(new com.hypixel.hytale.server.core.Message[0]));
    }
    ...
    private static com.hypixel.hytale.server.core.Message processLine(String line) {
        if (line == null || line.isEmpty()) {
            return com.hypixel.hytale.server.core.Message.raw("");
        }

        List<com.hypixel.hytale.server.core.Message> messages = new ArrayList<>();
        ...
        return messages.isEmpty() ? com.hypixel.hytale.server.core.Message.raw("") : com.hypixel.hytale.server.core.Message.join(messages.toArray(new com.hypixel.hytale.server.core.Message[0]));
    }
    ...
    private static List<com.hypixel.hytale.server.core.Message> processSegmentWithUrls(String segment, int segmentStart, List<int[]> urlRanges,
    ...
    private static com.hypixel.hytale.server.core.Message buildMessage(String text, Color color, boolean bold, boolean italic, String linkUrl) {
        if (text.isEmpty()) {
            return com.hypixel.hytale.server.core.Message.raw("");
        }

        com.hypixel.hytale.server.core.Message msg = com.hypixel.hytale.server.core.Message.raw(text).color(color);
        if (bold)
            msg = msg.bold(true);
        if (italic)
            msg = msg.italic(true);
